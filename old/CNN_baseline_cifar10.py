...
# Update the file names and paths to be specific to CIFAR-10
MODEL_PATH = "models/cnn_baseline_cifar10.pth"
TRAIN_ACC_FILE = "./cnn_cifar10_val_acc.png"
TRAIN_LOSS_FILE = "./cnn_cifar10_training_loss.png"
VAL_LOSS_FILE = "./cnn_cifar10_val_loss.png"
CONF_MATRIX_FILE = "./cnn_cifar10_confusion_matrix.png"
CLASS_REPORT_FILE = "./cnn_cifar10_classification_report.txt"
